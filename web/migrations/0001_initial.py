# -*- coding: utf-8 -*-
# Generated by Django 1.10.6 on 2017-03-25 07:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_slug', models.SlugField(blank=True, max_length=30, unique=True, verbose_name='Blueprint Name Slug')),
        ...
        migrations.AddField(
            model_name='blueprint',
            name='related_tasks',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='blueprint_tasks', to='web.BlueprintTasks'),
        ),
        migrations.AddField(
            model_name='blueprint',
            name='related_user',
