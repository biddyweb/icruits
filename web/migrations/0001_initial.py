    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_slug', models.SlugField(max_length=30, unique=True, verbose_name='Blueprint Name Slug')),
                ...
                ('legal_status', models.CharField(max_length=255, verbose_name='Legal Status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expert', models.CharField(max_length=255, verbose_name='Expert')),
                ('expert_email', models.CharField(max_length=255, verbose_name='Expert Email')),
                ('tast_status', models.CharField(choices=[('Active', 'Active'), ('Finished', 'Finished'), ('Canceled', 'Canceled'), ('Prolonged', 'Prolonged')], max_length=255)),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created At')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Updated_At')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('experience_level', models.CharField(choices=[('Any', 'Any'), ('Fresher', 'Fresher'), ('Intern', 'Intern'), ('Experienced', 'Experienced'), ('Trainee', 'Trainee')], max_length=255)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('success', models.CharField(choices=[('Any', 'Any'), ('Contract', 'Contract')], max_length=100)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('candidate_status', models.CharField(choices=[('Active', 'Active'), ('Hired', 'Hired'), ('Available', 'Available')], max_length=255)),
                ('candidate_position', models.IntegerField(default=0)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('blueprint', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='blueprint_name', to='web.Blueprint')),
                ('candidate', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='candidate_name', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'Queue',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('response_time', models.CharField(choices=[('Any', 'Any'), ('Within 7 Days', 'Within 7 Days'), ('Within Month', 'Within Month')], max_length=150)),
            ],
            options={
        ...
        migrations.AddField(
            model_name='blueprint',
            name='related_tasks',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='blueprint_tasks', to='web.BlueprintTasks'),
        ),
        migrations.AddField(
            model_name='blueprint',
            name='related_user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='blueprint_user', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='blueprint',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='profile_type', to='web.ProfileType'),
        ),
        migrations.AddField(
            model_name='user',
